          ...
          return (
            ...
            >
              <View className="w-14 h-14 rounded-2xl bg-brand-50 border border-brand-100 items-center justify-center mr-4">
                <FontAwesome name="user" size={20} color="#047857" />
              </View>
              <View className="flex-1 mr-3">
                ...
                <View className="flex-row items-center">
                  <Text className="text-neutral-950 font-bold text-lg leading-6 flex-1" numberOfLines={1}>{nombreUsuario(participante)}</Text>
                  {participante?.usu_identidad_verificada ? <FontAwesome name="check-circle" size={15} color="#047857" /> : null}
                </View>
